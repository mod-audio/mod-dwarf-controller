...
************************************************************************************************************************
*/
typedef enum {MENU_ROOT, MENU_MAIN, MENU_TOGGLE, MENU_LIST, MENU_BAR, MENU_NONE, MENU_OK, MENU_CONFIRM, MENU_CONFIRM2, MENU_TOOL, MENU_FOOT, MENU_CLICK_LIST} menu_types_t;
