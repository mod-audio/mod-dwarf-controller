...
#define SYSTEM_MENU     \
    ...
    {"INPUT STEREO LINK",               MENU_TOGGLE,    INP_STEREO_LINK,        AUDIO_INP_ID,       system_sl_in_cb            , 0},  \
    ...
    {"OUTPUT STEREO LINK",              MENU_TOGGLE,    OUTP_STEREO_LINK,       AUDIO_OUTP_ID,      system_sl_out_cb           , 0},  \
...
#define EEPROM_CURRENT_VERSION             0L
