...
LCD_RET_CODE LCD_Init (LCD_Config_Type* pConfig)
{
	...
	// Assign pins
	PINSEL_SetPinFunc(0,4,7);
	PINSEL_SetPinFunc(0,5,7);
	PINSEL_SetPinFunc(0,6,7);
	PINSEL_SetPinFunc(0,7,7);
	PINSEL_SetPinFunc(0,8,7);
	PINSEL_SetPinFunc(0,9,7);
	PINSEL_SetPinFunc(1,20,7);
	PINSEL_SetPinFunc(1,21,7);
	PINSEL_SetPinFunc(1,22,7);
	PINSEL_SetPinFunc(1,23,7);
	PINSEL_SetPinFunc(1,24,7);
	PINSEL_SetPinFunc(1,25,7);
	PINSEL_SetPinFunc(1,26,7);
	PINSEL_SetPinFunc(1,27,7);
	PINSEL_SetPinFunc(1,28,7);
	PINSEL_SetPinFunc(1,29,7);
	PINSEL_SetPinFunc(2,2,7);
	PINSEL_SetPinFunc(2,3,7);
	PINSEL_SetPinFunc(2,4,7);
	PINSEL_SetPinFunc(2,5,7);
	PINSEL_SetPinFunc(2,6,7);
	PINSEL_SetPinFunc(2,7,7);
	PINSEL_SetPinFunc(2,8,7);
	PINSEL_SetPinFunc(2,9,7);
	PINSEL_SetPinFunc(2,12,7);
	PINSEL_SetPinFunc(2,13,7);
	PINSEL_SetPinFunc(4,28,7);
	PINSEL_SetPinFunc(4,29,7);
