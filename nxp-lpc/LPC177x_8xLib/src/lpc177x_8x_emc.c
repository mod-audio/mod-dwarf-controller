...
EMC_FUNC_CODE DynMem_Init(EMC_DYN_MEM_Config_Type* pConfig)
{
    ...
    * P4.25 - EMC_WE
    */
    PINSEL_SetPinFunc(2,16,1);
    PINSEL_SetPinFunc(2,17,1);
    PINSEL_SetPinFunc(2,18,1);
    PINSEL_SetPinFunc(2,19,1);
    PINSEL_SetPinFunc(2,20,1);
    PINSEL_SetPinFunc(2,21,1);
    PINSEL_SetPinFunc(2,22,1);
    PINSEL_SetPinFunc(2,23,1);
    PINSEL_SetPinFunc(2,24,1);
    PINSEL_SetPinFunc(2,25,1);
    PINSEL_SetPinFunc(2,26,1);
    PINSEL_SetPinFunc(2,27,1);
    PINSEL_SetPinFunc(2,28,1);
    PINSEL_SetPinFunc(2,29,1);
    PINSEL_SetPinFunc(2,30,1);
    PINSEL_SetPinFunc(2,31,1);

    for(i = 0; i < 32; i++)
    {
        PINSEL_SetPinFunc(3,i,1);
        PINSEL_SetPinFunc(4,i,1);
    }
    PINSEL_SetPinFunc(5,0,1);
    PINSEL_SetPinFunc(5,1,1);
...
EMC_FUNC_CODE StaticMem_Init(EMC_STATIC_MEM_Config_Type* pConfig)
{
    ...
    */
    PINSEL_SetPinFunc(2,14,1);
    PINSEL_SetPinFunc(2,15,1);
...
EMC_FUNC_CODE EMC_DynMemConfigAM(uint32_t index , 
                                                                       ...
                                                                       uint16_t chip_size)
{
    const     uint32_t  chip_max_size   =  512;  // 512Mb
